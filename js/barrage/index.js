let data = [
    {
        value: '77777777777777777777777777777777777777777777777',
        time: 5,
        color: 'red',
        speed: 1,
        fontSize:22
...
class CanvasBarrage{
    ...
    renderBarrage(){
        // 要根据当前视频播放的时间和弹幕展示作比较，来判断是否展示弹幕
        let time = this.video.currentTime

        this.barrages.forEach(barrage => {
            // 只有在视频播放时间大于等于弹幕展示时间才做处理
...
class Barrage{
    ...
    init(){
        ...
        document.body.removeChild(p) // 用完就抛弃
