...
## 自我介绍 
> 面试官您好 我叫李斌 今年20岁 现在是大三 在大二的时候学校开设的前端课程开始接触前端， 系统地学习大概有一年时间，我对Vue和React都有过学习， 也都有写过简单的项目 也用到了Vuex和Redux，但是现在主要学习React，Vue忘记了许多，因为React中的JSX语法更加接近原生的JS语法，他也能达到训练JS能力，让开发者不是那么地依赖框架地去开发以及React背后强大地运营团队和良好的生态环境，所以我最终还是选择去主React，想找一个React技术栈相关的前端实习岗位，谢谢
